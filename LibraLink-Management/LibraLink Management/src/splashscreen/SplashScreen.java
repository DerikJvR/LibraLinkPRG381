...
public class SplashScreen extends javax.swing.JDialog {
        ...
        curvesPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(curvesPanel1Layout.createSequentialGroup()
                ...
                .addGroup(curvesPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(pro, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Connect To Database ...", 5);
                    doTask("Connecting to the library ...", 10);
                    doTask("Gathering all the books ...", 25);
                    doTask("Sending overdue notices ...", 30);
                    doTask("Warming up the coffee machine ...", 40);
                    doTask("Organizing the book shelves ...", 55);
                    doTask("Training the virtual librarian ...", 60);
                    doTask("Charging the library robot ...", 70);
                    doTask("Validating library cards ...", 85);
                    doTask("Setting up the book scanner ...", 90);
                    doTask("Opening the library doors ...", 100);
                    doTask("Done! The library is ready for you! ...", 100);
                    doTask("Done! The library is ready for you! ...", 100);
                    dispose();
